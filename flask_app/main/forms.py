...
class ApplyToGuildForm(FlaskForm):
    ...
    find_how = RadioField('How did you find us?', choices=[('value_1', 'Google'), ('value_2', 'Forum post'), ('value_3', 'Friend Refered'), ('value_3', 'Other')], validators=[DataRequired()])
    self_description = StringField('Describe yourself and what your looking for in a guild', validators=[DataRequired()])
